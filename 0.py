...
class GAN():
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        # 加载数据集
        (X_train, _), (_, _) = load_data(path="./mnist.npz")
        # 归一化到-1到1
        ...
        self.generator.save_weights("keras_model/G_model.hdf5" % epoch, True)
        self.discriminator.save_weights("keras_model/D_mode.hdf5" % epoch, True)
...
if __name__ == '__main__':
    gan = GAN()
    gan.train(epochs=300, batch_size=32, sample_interval=10)
    gan.test()